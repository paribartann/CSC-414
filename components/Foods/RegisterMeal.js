  ...
  checkforDonors() {
    ...
    query.once("value").then(function(snapshot) {
      ...
      if (Donors.length > 0) {
        ...
        axios
          .post(
            "https://us-central1-csc-414-survival-app.cloudfunctions.net/sendMail",
            data
          )
          .then(res => {
        ...
        firebase
          .database()
          .ref(`RecipientList/${Recipients[0].id}`)
          .remove();
      } else {
        ...
        <ScrollView style={{ flex: 1 }}>
          <View style={styles.container}>
            ...
            <Form style={styles.form}>
              ...
              <TouchableOpacity
                primary
                onPress={this.addRecipient.bind(this)}
                style={styles.button}
              >
